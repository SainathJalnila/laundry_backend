...
export function validateWithZod<T>(schema: ZodSchema<T>, data: unknown): ValidationResult {
...
export function zodValidate<T>(schema: ZodSchema<T>, part: RequestPart = 'body') {
    return (req: Request, res: Response, next: NextFunction) => {
        ...
        const dataToValidate = (req as any)[part] ?? {};
        ...
        (req as any)[part] = result.data as T;
        return next();
    };
}
